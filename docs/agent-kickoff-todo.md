...
- Prefer a shallow dependency tree and readable pure-Python code where
  practical.
...
- Add or outline one notebook walkthrough for a recognizable neighborhood-scale
  example.
- Tighten the README so the value proposition, data sources, and first
